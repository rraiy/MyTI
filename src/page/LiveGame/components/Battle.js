...
import LOGO from '../../../images/team_logo/PSG.LGD.png';
import Elephant from '../../../images/team_logo/Elephant.png';
    ...
    db.collection('live_game')
      ...
      .then((res) => {
        ...
        if (team1Count && team2Count) {
          const team1Rating = Math.round((team1Count / (team1Count + team2Count)) * 10000) / 100;
